...
class HomeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0 {
            ...
            vc.album = modelVC.albums[indexPath.row].self
            vc.modalPresentationStyle = .fullScreen
        ...
        if indexPath.section == 1 {
            ...
            navigationController?.pushViewController(vc, animated: true)
            vc.modalPresentationStyle = .fullScreen
            vc.playlist = modelVC.playlist[indexPath.row].self
        }
        if indexPath.section == 2 {
            ...
            navigationController?.pushViewController(vc, animated: true)
            vc.modalPresentationStyle = .fullScreen
            vc.itemArray.append(modelVC.tracksRecomendation[indexPath.row].preview_url ?? "")
            vc.imageView.append((modelVC.tracksRecomendation[indexPath.row].album?.images.first?.url)!)
            vc.names.append(modelVC.tracksRecomendation[indexPath.row].name)
            vc.namesTrack.append(modelVC.tracksRecomendation[indexPath.row].artists.first?.name ?? "")
        }
    }
}

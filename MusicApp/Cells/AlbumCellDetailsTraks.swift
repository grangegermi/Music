...
protocol ButtonDelegate:AnyObject {
    func  addToLike(_ sender:UIButton)
}
...
class AlbumCellDetailsTraks: UICollectionViewCell{
        ...
        var link:AlbumViewController?
        var librarylink: LibraryLikeVC?
...
//            contentView.addSubview(buttonLikeFull)
...
//            buttonLike.addTarget(self, action: #selector(addToLike), for: .touchUpInside)
//            buttonLikeFull.addTarget(self, action: #selector(addToLike), for: .touchUpInside)
...
//            var imageLikeFull = UIImage(systemName: "suit.heart.fill", withConfiguration: UIImage.SymbolConfiguration(pointSize: 20, weight: .regular))
            //
//            buttonLikeFull.setImage(imageLikeFull, for: .normal)
//            buttonLikeFull.tintColor = .white
//            buttonLikeFull.isHidden = true
//            buttonLikeFull.tag = 2
...
//            buttonLikeFull.snp.makeConstraints { make in
//                make.right.equalTo(view.snp.right).inset(60)
//                make.width.equalTo(30)
//                make.height.equalTo(30)
//                make.centerY.equalTo(view.snp.centerY)
